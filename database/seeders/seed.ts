    ...
    const trainers = await Trainer.insertMany([
      {
        ...
        profilePictureUrl: 'https://res.cloudinary.com/elitefit/trainer-sarah.jpg',
        availability: [
      ...
      },
      {
        ...
        profilePictureUrl: 'https://res.cloudinary.com/elitefit/trainer-marcus.jpg',
        availability: [
    ...
    await Blog.insertMany([
      {
        ...
        thumbnailUrl: 'https://res.cloudinary.com/elitefit/blogs/warmup.jpg',
        isPublished: true,
        publishedAt: today
      },
      {
        ...
        thumbnailUrl: 'https://res.cloudinary.com/elitefit/blogs/nutrition.jpg',
        isPublished: true,
        publishedAt: today
      }
    ]);
